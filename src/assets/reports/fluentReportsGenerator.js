    ...
    */
    ...
    buildUI(idOrElement) {
        ...
        if (this._includeCSS) {
            ...
            link.setAttribute('href', '../../assets/reports/fr.css');
        ...
        if (this._includeJS) {
            ...
            script.src = "../../assets/reports/plain-draggable.min.js";
            document.getElementsByTagName('head')[0].appendChild(script);
            let frScript = document.createElement('script');
            if (this.debugging) {
                frScript.src = "../../assets/reports/fluentReportsBrowser.js";
            } else {
                frScript.src = "../../assets/reports/fluentReportsBrowser.min.js";
            }
...
module.exports = FluentReportsGenerator;